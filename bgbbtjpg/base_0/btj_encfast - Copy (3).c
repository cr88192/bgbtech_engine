...
void BTJ_JFEH_EncodeBlock(short *buf, int dctab, int actab)
{
	int i, j, k;
	...
	int xs, int ys, int qf, int pf)
{
	...
	BTJ_JFE_MakeQuantTabFastIJG_Y(btj_jfe_qt[0], (qf&255)/100.0);
	BTJ_JFE_MakeQuantTabFastIJG_UV(btj_jfe_qt[1], (qf&255)/100.0);
