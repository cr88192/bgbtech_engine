...
namespace BGBTechBTJ
{
    ...
    class PDJPG_TransDCT
    {
        ...
        public static void PDJPG_TransDCT_Vert(IntPtr iblk, IntPtr oblk)
        {
    ...
    {
#if true
        public static void PDJPG_TransIDCT_Horiz(ShortPtr iblk, IntPtr oblk)
        {
            int a, b, c, d, e, f;
            int i, j, k, l;
            int m, n, o, p;
        ...
        public static void PDJPG_TransIDCT_Vert(IntPtr iblk, IntPtr oblk)
        {
            int a, b, c, d, e, f;
            int i, j, k, l;
            int m, n, o, p;
        ...
        public static void PDJPG_TransIDCT16(ShortPtr iblk, ShortPtr oblk, int dcbias)
        {
            IntPtr s = new IntPtr(PDJPG.DCTSZ2);
            IntPtr t = new IntPtr(PDJPG.DCTSZ2);
            int i, j;
    ...
    class PDJPG_TransRDCT
    {
...
#if true
        public static void PDJPG_TransRDCT_Ref(
            ...
            out int oblk4, out int oblk5, out int oblk6, out int oblk7)
        {
            ...
            //(int)(v+0.5)
            //9542 -23128 4403 -4962 10017 -3116 236
            //-9116 467 -3859 843 128 -3674 -3783
            //-560 2218 -2217 -1830 2104 -2625 3147
            //-297 -14011 -8191 2512 5465 -4876 1670
            //6518 7917 3636 5057 -1164 8502 -1392
            //3761 3365 -1697 -8866 5793 7269 -2061
            //-5384 4760 -2400 -4346 -7151 -1305 -2915
            //8212 -5881 -759 -260 3416 9556 4017
            //9028 -16634 -3178 5375 10162 13580 -9759
...
#if false
            ib7 = (-ib7) + ((ib0 * 9542 + ib1 * -23129 + ib2 * 4403 + ib3 * -4963 + ib4 * 10017 + ib5 * -3117 + ib6 * 236) >> 13);
            ib0 = ib0 + ((ib1 * -9117 + ib2 * 467 + ib3 * -3860 + ib4 * 843 + ib5 * 128 + ib6 * -3675 + ib7 * -3784) >> 13);
            ib1 = ib1 + ((ib0 * -561 + ib2 * 2218 + ib3 * -2218 + ib4 * -1831 + ib5 * 2104 + ib6 * -2626 + ib7 * 3147) >> 13);
            ib2 = ib2 + ((ib0 * -298 + ib1 * -14012 + ib3 * -8192 + ib4 * 2512 + ib5 * 5465 + ib6 * -4877 + ib7 * 1670) >> 13);
            ib3 = ib3 + ((ib0 * 6518 + ib1 * 7917 + ib2 * 3636 + ib4 * 5057 + ib5 * -1165 + ib6 * 8502 + ib7 * -1393) >> 13);
            ib4 = ib4 + ((ib0 * 3761 + ib1 * 3365 + ib2 * -1698 + ib3 * -8867 + ib5 * 5793 + ib6 * 7269 + ib7 * -2062) >> 13);
            ib5 = ib5 + ((ib0 * -5385 + ib1 * 4760 + ib2 * -2401 + ib3 * -4347 + ib4 * -7152 + ib6 * -1306 + ib7 * -2916) >> 13);
            ib6 = ib6 + ((ib0 * 8212 + ib1 * -5882 + ib2 * -760 + ib3 * -261 + ib4 * 3416 + ib5 * 9556 + ib7 * 4017) >> 13);
            ib7 = ib7 + ((ib0 * 9028 + ib1 * -16635 + ib2 * -3179 + ib3 * 5375 + ib4 * 10162 + ib5 * 13580 + ib6 * -9760) >> 13);
#endif

#if false
            //9542 -23129 4403 -4963 10017 -3117 236
            ib7 = (-ib7) + FIX14TOI(
                ib0 * 9542 + ib1 * -23129 + ib2 * 4403 + ib3 * -4963 + ib4 * 10017 + ib5 * -3117 + ib6 * 236);
            //-9117 467 -3860 843 128 -3675 -3784
            ib0 = ib0 + FIX14TOI(
                ib1 * -9117 + ib2 * 467 + ib3 * -3860 + ib4 * 843 + ib5 * 128 + ib6 * -3675 + ib7 * -3784);
            //-561 2218 -2218 -1831 2104 -2626 3147
            ib1 = ib1 + FIX14TOI(
                ib0 * -561 + ib2 * 2218 + ib3 * -2218 + ib4 * -1831 + ib5 * 2104 + ib6 * -2626 + ib7 * 3147);
            //-298 -14012 -8192 2512 5465 -4877 1670
            ib2 = ib2 + FIX14TOI(
                ib0 * -298 + ib1 * -14012 + ib3 * -8192 + ib4 * 2512 + ib5 * 5465 + ib6 * -4877 + ib7 * 1670);
            //6518 7917 3636 5057 -1165 8502 -1393
            ib3 = ib3 + FIX14TOI(
                ib0 * 6518 + ib1 * 7917 + ib2 * 3636 + ib4 * 5057 + ib5 * -1165 + ib6 * 8502 + ib7 * -1393);
            //3761 3365 -1698 -8867 5793 7269 -2062
            ib4 = ib4 + FIX14TOI(
                ib0 * 3761 + ib1 * 3365 + ib2 * -1698 + ib3 * -8867 + ib5 * 5793 + ib6 * 7269 + ib7 * -2062);
            //-5385 4760 -2401 -4347 -7152 -1306 -2916
            ib5 = ib5 + FIX14TOI(
                ib0 * -5385 + ib1 * 4760 + ib2 * -2401 + ib3 * -4347 + ib4 * -7152 + ib6 * -1306 + ib7 * -2916);
            //8212 -5882 -760 -261 3416 9556 4017
            ib6 = ib6 + FIX14TOI(
                ib0 * 8212 + ib1 * -5882 + ib2 * -760 + ib3 * -261 + ib4 * 3416 + ib5 * 9556 + ib7 * 4017);
            //9028 -16635 -3179 5375 10162 13580 -9760
            ib7 = ib7 + FIX14TOI(
                ib0 * 9028 + ib1 * -16635 + ib2 * -3179 + ib3 * 5375 + ib4 * 10162 + ib5 * 13580 + ib6 * -9760);
#endif

#if false
            ib7 = (-ib7) + FIX14TOI(
                ib0 * FLTOFIX14(1.1648) + ib1 * FLTOFIX14(-2.8234) +
                ib2 * FLTOFIX14(0.5375) + ib3 * FLTOFIX14(-0.6058) +
                ib4 * FLTOFIX14(1.2228) + ib5 * FLTOFIX14(-0.3805) +
                ib6 * FLTOFIX14(0.0288));
            ib0 = ib0 + FIX14TOI(
                ib1 * FLTOFIX14(-1.1129) + ib2 * FLTOFIX14(0.0570) +
                ib3 * FLTOFIX14(-0.4712) + ib4 * FLTOFIX14(0.1029) +
                ib5 * FLTOFIX14(0.0156) + ib6 * FLTOFIX14(-0.4486) +
                ib7 * FLTOFIX14(-0.4619));
            ib1 = ib1 + FIX14TOI(
                ib0 * FLTOFIX14(-0.0685) + ib2 * FLTOFIX14(0.2708) +
                ib3 * FLTOFIX14(-0.2708) + ib4 * FLTOFIX14(-0.2235) +
                ib5 * FLTOFIX14(0.2568) + ib6 * FLTOFIX14(-0.3205) +
                ib7 * FLTOFIX14(0.3841));
            ib2 = ib2 + FIX14TOI(
                ib0 * FLTOFIX14(-0.0364) + ib1 * FLTOFIX14(-1.7104) +
                ib3 * FLTOFIX14(-1.0000) + ib4 * FLTOFIX14(0.3066) +
                ib5 * FLTOFIX14(0.6671) + ib6 * FLTOFIX14(-0.5953) +
                ib7 * FLTOFIX14(0.2039));
            ib3 = ib3 + FIX14TOI(
                ib0 * FLTOFIX14(0.7957) + ib1 * FLTOFIX14(0.9664) +
                ib2 * FLTOFIX14(0.4439) + ib4 * FLTOFIX14(0.6173) +
                ib5 * FLTOFIX14(-0.1422) + ib6 * FLTOFIX14(1.0378) +
                ib7 * FLTOFIX14(-0.1700));
            ib4 = ib4 + FIX14TOI(
                ib0 * FLTOFIX14(0.4591) + ib1 * FLTOFIX14(0.4108) +
                ib2 * FLTOFIX14(-0.2073) + ib3 * FLTOFIX14(-1.0824) +
                ib5 * FLTOFIX14(0.7071) + ib6 * FLTOFIX14(0.8873) +
                ib7 * FLTOFIX14(-0.2517));
            ib5 = ib5 + FIX14TOI(
                ib0 * FLTOFIX14(-0.6573) + ib1 * FLTOFIX14(0.5810) +
                ib2 * FLTOFIX14(-0.2931) + ib3 * FLTOFIX14(-0.5307) +
                ib4 * FLTOFIX14(-0.8730) + ib6 * FLTOFIX14(-0.1594) +
                ib7 * FLTOFIX14(-0.3560));
            ib6 = ib6 + FIX14TOI(
                ib0 * FLTOFIX14(1.0024) + ib1 * FLTOFIX14(-0.7180) +
                ib2 * FLTOFIX14(-0.0928) + ib3 * FLTOFIX14(-0.0318) +
                ib4 * FLTOFIX14(0.4170) + ib5 * FLTOFIX14(1.1665) +
                ib7 * FLTOFIX14(0.4904));
            ib7 = ib7 + FIX14TOI(
                ib0 * FLTOFIX14(1.1020) + ib1 * FLTOFIX14(-2.0306) +
                ib2 * FLTOFIX14(-0.3881) + ib3 * FLTOFIX14(0.6561) +
                ib4 * FLTOFIX14(1.2405) + ib5 * FLTOFIX14(1.6577) +
                ib6 * FLTOFIX14(-1.1914));
#endif
            oblk0 = ib3; oblk1 = ib6;
            oblk2 = ib4; oblk3 = ib2;
            oblk4 = ib5; oblk5 = ib7;
...
//            IntPtr t = new IntPtr(PDJPG.DCTSZ2);
        ...
        public static void PDJPG_TransRDCT_Horiz(ShortPtr iblk, IntPtr oblk, int dcbias)
        {
            int[] ib = new int[8];
        ...
        public static void PDJPG_TransRDCT_Vert(IntPtr iblk, IntPtr oblk)
        {
            int[] ib = new int[8];
    ...
    class PDJPG_TransIRDCT
    {
...
#if true
        public static void PDJPG_TransIRDCT_Ref(
            int iblk0, int iblk1, int iblk2, int iblk3,
            int iblk4, int iblk5, int iblk6, int iblk7,
            out int oblk0, out int oblk1, out int oblk2, out int oblk3,
            out int oblk4, out int oblk5, out int oblk6, out int oblk7)
...
#if false
            //9028 -16635 -3179 5375 10162 13580 -9760
            ib7 = ib7 - FIX14TOI(ib0 * 9028 + ib1 * -16635 + ib2 * -3179 + ib3 * 5375 + ib4 * 10162 + ib5 * 13580 + ib6 * -9760);
            //8212 -5882 -760 -261 3416 9556 4017
            ib6 = ib6 - FIX14TOI(ib0 * 8212 + ib1 * -5882 + ib2 * -760 + ib3 * -261 + ib4 * 3416 + ib5 * 9556 + ib7 * 4017);
            //-5385 4760 -2401 -4347 -7152 -1306 -2916
            ib5 = ib5 - FIX14TOI(ib0 * -5385 + ib1 * 4760 + ib2 * -2401 + ib3 * -4347 + ib4 * -7152 + ib6 * -1306 + ib7 * -2916);
            //3761 3365 -1698 -8867 5793 7269 -2062
            ib4 = ib4 - FIX14TOI(ib0 * 3761 + ib1 * 3365 + ib2 * -1698 + ib3 * -8867 + ib5 * 5793 + ib6 * 7269 + ib7 * -2062);
            //6518 7917 3636 5057 -1165 8502 -1393
            ib3 = ib3 - FIX14TOI(ib0 * 6518 + ib1 * 7917 + ib2 * 3636 + ib4 * 5057 + ib5 * -1165 + ib6 * 8502 + ib7 * -1393);
            //-298 -14012 -8192 2512 5465 -4877 1670
            ib2 = ib2 - FIX14TOI(ib0 * -298 + ib1 * -14012 + ib3 * -8192 + ib4 * 2512 + ib5 * 5465 + ib6 * -4877 + ib7 * 1670);
            //-561 2218 -2218 -1831 2104 -2626 3147
            ib1 = ib1 - FIX14TOI(ib0 * -561 + ib2 * 2218 + ib3 * -2218 + ib4 * -1831 + ib5 * 2104 + ib6 * -2626 + ib7 * 3147);
            //-9117 467 -3860 843 128 -3675 -3784
            ib0 = ib0 - FIX14TOI(ib1 * -9117 + ib2 * 467 + ib3 * -3860 + ib4 * 843 + ib5 * 128 + ib6 * -3675 + ib7 * -3784);
            //9542 -23129 4403 -4963 10017 -3117 236
            ib7 = -ib7 + FIX14TOI(ib0 * 9542 + ib1 * -23129 + ib2 * 4403 + ib3 * -4963 + ib4 * 10017 + ib5 * -3117 + ib6 * 236);
#endif
        ...
        public static void TransBlock(ShortPtr iblk, ShortPtr oblk, int dcbias)
        {
            ...
            PDJPG_TransIRDCT_Ref(iblk[0], iblk[8], iblk[16], iblk[24], iblk[32], iblk[40], iblk[48], iblk[56],
                out s00, out s10, out s20, out s30, out s40, out s50, out s60, out s70);
            PDJPG_TransIRDCT_Ref(iblk[1], iblk[9], iblk[17], iblk[25], iblk[33], iblk[41], iblk[49], iblk[57],
                out s01, out s11, out s21, out s31, out s41, out s51, out s61, out s71);
            PDJPG_TransIRDCT_Ref(iblk[2], iblk[10], iblk[18], iblk[26], iblk[34], iblk[42], iblk[50], iblk[58],
                out s02, out s12, out s22, out s32, out s42, out s52, out s62, out s72);
            PDJPG_TransIRDCT_Ref(iblk[3], iblk[11], iblk[19], iblk[27], iblk[35], iblk[43], iblk[51], iblk[59],
                out s03, out s13, out s23, out s33, out s43, out s53, out s63, out s73);
            PDJPG_TransIRDCT_Ref(iblk[4], iblk[12], iblk[20], iblk[28], iblk[36], iblk[44], iblk[52], iblk[60],
                out s04, out s14, out s24, out s34, out s44, out s54, out s64, out s74);
            PDJPG_TransIRDCT_Ref(iblk[5], iblk[13], iblk[21], iblk[29], iblk[37], iblk[45], iblk[53], iblk[61],
                out s05, out s15, out s25, out s35, out s45, out s55, out s65, out s75);
            PDJPG_TransIRDCT_Ref(iblk[6], iblk[14], iblk[22], iblk[30], iblk[38], iblk[46], iblk[54], iblk[62],
                out s06, out s16, out s26, out s36, out s46, out s56, out s66, out s76);
            PDJPG_TransIRDCT_Ref(iblk[7], iblk[15], iblk[23], iblk[31], iblk[39], iblk[47], iblk[55], iblk[63],
                out s07, out s17, out s27, out s37, out s47, out s57, out s67, out s77);

            PDJPG_TransIRDCT_Ref(s00, s01, s02, s03, s04, s05, s06, s07,
                out t00, out t01, out t02, out t03, out t04, out t05, out t06, out t07);
            PDJPG_TransIRDCT_Ref(s10, s11, s12, s13, s14, s15, s16, s17,
                out t10, out t11, out t12, out t13, out t14, out t15, out t16, out t17);
            PDJPG_TransIRDCT_Ref(s20, s21, s22, s23, s24, s25, s26, s27,
                out t20, out t21, out t22, out t23, out t24, out t25, out t26, out t27);
            PDJPG_TransIRDCT_Ref(s30, s31, s32, s33, s34, s35, s36, s37,
                out t30, out t31, out t32, out t33, out t34, out t35, out t36, out t37);
            PDJPG_TransIRDCT_Ref(s40, s41, s42, s43, s44, s45, s46, s47,
                out t40, out t41, out t42, out t43, out t44, out t45, out t46, out t47);
            PDJPG_TransIRDCT_Ref(s50, s51, s52, s53, s54, s55, s56, s57,
                out t50, out t51, out t52, out t53, out t54, out t55, out t56, out t57);
            PDJPG_TransIRDCT_Ref(s60, s61, s62, s63, s64, s65, s66, s67,
                out t60, out t61, out t62, out t63, out t64, out t65, out t66, out t67);
            PDJPG_TransIRDCT_Ref(s70, s71, s72, s73, s74, s75, s76, s77,
                out t70, out t71, out t72, out t73, out t74, out t75, out t76, out t77);

            oblk[0] = t00 + dcbias; oblk[1] = t01 + dcbias; oblk[2] = t02 + dcbias; oblk[3] = t03 + dcbias;
            oblk[4] = t04 + dcbias; oblk[5] = t05 + dcbias; oblk[6] = t06 + dcbias; oblk[7] = t07 + dcbias;
            oblk[8] = t10 + dcbias; oblk[9] = t11 + dcbias; oblk[10] = t12 + dcbias; oblk[11] = t13 + dcbias;
            oblk[12] = t14 + dcbias; oblk[13] = t15 + dcbias; oblk[14] = t16 + dcbias; oblk[15] = t17 + dcbias;
            oblk[16] = t20 + dcbias; oblk[17] = t21 + dcbias; oblk[18] = t22 + dcbias; oblk[19] = t23 + dcbias;
            oblk[20] = t24 + dcbias; oblk[21] = t25 + dcbias; oblk[22] = t26 + dcbias; oblk[23] = t27 + dcbias;
            oblk[24] = t30 + dcbias; oblk[25] = t31 + dcbias; oblk[26] = t32 + dcbias; oblk[27] = t33 + dcbias;
            oblk[28] = t34 + dcbias; oblk[29] = t35 + dcbias; oblk[30] = t36 + dcbias; oblk[31] = t37 + dcbias;
            oblk[32] = t40 + dcbias; oblk[33] = t41 + dcbias; oblk[34] = t42 + dcbias; oblk[35] = t43 + dcbias;
            oblk[36] = t44 + dcbias; oblk[37] = t45 + dcbias; oblk[38] = t46 + dcbias; oblk[39] = t47 + dcbias;
            oblk[40] = t50 + dcbias; oblk[41] = t51 + dcbias; oblk[42] = t52 + dcbias; oblk[43] = t53 + dcbias;
            oblk[44] = t54 + dcbias; oblk[45] = t55 + dcbias; oblk[46] = t56 + dcbias; oblk[47] = t57 + dcbias;
            oblk[48] = t60 + dcbias; oblk[49] = t61 + dcbias; oblk[50] = t62 + dcbias; oblk[51] = t63 + dcbias;
            oblk[52] = t64 + dcbias; oblk[53] = t65 + dcbias; oblk[54] = t66 + dcbias; oblk[55] = t67 + dcbias;
            oblk[56] = t70 + dcbias; oblk[57] = t71 + dcbias; oblk[58] = t72 + dcbias; oblk[59] = t73 + dcbias;
            oblk[60] = t74 + dcbias; oblk[61] = t75 + dcbias; oblk[62] = t76 + dcbias; oblk[63] = t77 + dcbias;
        }
#endif

#if false
        public static void PDJPG_TransIRDCT_Horiz(IntPtr iblk, IntPtr oblk)
        {
            int[] ib = new int[8];
        ...
        public static void PDJPG_TransIRDCT_Vert(ShortPtr iblk, IntPtr oblk)
        {
            int[] ib = new int[8];
