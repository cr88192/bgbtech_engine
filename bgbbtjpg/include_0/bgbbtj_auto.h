...
void BGBBTJ_Huff_DequantBlock(BGBBTJ_JPG_Context *ctx, short *ibuf, short *obuf, int qid);
...
u16 BGBBTJ_BT1C_DecodeSingleColor565(BGBBTJ_BTIC1C_ImageInfo *ctx, byte **rcs, int mode);
...
void BTIC2C_DecodeColorTransformYCgCo420_SubBlock4x4_NfRGBA(s32 *yb, s32 *ub, s32 *vb, s32 *ab, byte *obuf, int xs, int ys);
void BTIC2C_DecodeColorTransformYCgCo420_SubBlock8x8_NfRGBA(s32 *yb, s32 *ub, s32 *vb, s32 *ab, byte *obuf, int xs, int ys);
void BTIC2C_DecodeColorTransformYCgCo420_NfBlock2(BTIC2C_Context *ctx, byte *obuf, int xo, int yo, int clrs);
void BTIC2C_DecodeColorTransformYCgCo420_SubBlock4x4_RGBA(s32 *yb, s32 *ub, s32 *vb, s32 *ab, byte *obuf, int xs, int ys);
void BTIC2C_DecodeColorTransformYCgCo420_SubBlock8x8_RGBA(s32 *yb, s32 *ub, s32 *vb, s32 *ab, byte *obuf, int xs, int ys);
void BTIC2C_DecodeColorTransformYCgCo420A_Block2_RGBA(BTIC2C_Context *ctx, byte *obuf, int xo, int yo, int clrs);
void BTIC2C_DecodeColorTransformYCgCo420_SubBlock4x4_BGRA(s32 *yb, s32 *ub, s32 *vb, s32 *ab, byte *obuf, int xs, int ys);
void BTIC2C_DecodeColorTransformYCgCo420_SubBlock8x8_BGRA(s32 *yb, s32 *ub, s32 *vb, s32 *ab, byte *obuf, int xs, int ys);
void BTIC2C_DecodeColorTransformYCgCo420A_Block2_BGRA(BTIC2C_Context *ctx, byte *obuf, int xo, int yo, int clrs);
...
int BTIC2C_DecodeColorTransformYCgCo420(BTIC2C_Context *ctx, byte *obuf, int clrs);
int BTIC2C_DecodeColorTransformYCbCr420(BTIC2C_Context *ctx, byte *obuf, int clrs);
int BTIC2C_DecodeColorTransformYCbCr420(BTIC2C_Context *ctx, byte *obuf, int clrs);
int BTIC2C_DecodeColorTransform(BTIC2C_Context *ctx,byte *obuf, int clrs);
...
int BTIC2C_FilterImageDeltaWHT(BTIC2C_Context *ctx,s32 *ibuf, s32 *libuf, s32 *obuf, byte *bmbuf, int qid, int xs, int ys);
int BTIC2C_FilterImageDeltaIWHT(BTIC2C_Context *ctx,s32 *imgbuf, s32 *limgbuf, s32 *blkbuf, byte *bmbuf, int qid, int xs, int ys);
