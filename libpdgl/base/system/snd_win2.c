...
//		printf("Sound resync %d\n", snd_rover-dma);
		...
		PDGL_Sound_MixPopReduceStereo2(buf, samples, snd_rover-buf, 64);
		PDGL_Sound_MixPopReduceStereo2(buf, samples, dma-buf, 64);

//		PDGL_Sound_MixPopReduceStereo(snd_rover, 64);
//		PDGL_Sound_MixPopReduceStereo(dma, 64);
...
//	PDGL_Sound_MixPopReduceStereo(snd_rover, 16);
