...
PDGL_API void pdglStencilFunc(GLenum func,GLint ref, GLuint mask);
PDGL_API void pdglStencilMask(GLuint mask);
PDGL_API void pdglStencilOp(GLenum fail,GLenum zfail, GLenum zpass);
PDGL_API void pdglClearStencil(GLint s);
PDGL_API GLenum pdglGetError(void);
PDGL_API void pdglReadPixels( GLint x, GLint y,GLsizei width, GLsizei height, GLenum format, GLenum type, GLvoid *pixels);
PDGL_API void pdglDrawPixels( GLsizei width, GLsizei height,GLenum format, GLenum type, const GLvoid *pixels);
PDGL_API void pdglEnableClientState( GLenum cap );
PDGL_API void pdglDisableClientState( GLenum cap );
PDGL_API void pdglVertexPointer( GLint size,GLenum type, GLsizei stride, const GLvoid *ptr );
PDGL_API void pdglNormalPointer( GLenum type,GLsizei stride, const GLvoid *ptr );
PDGL_API void pdglColorPointer( GLint size,GLenum type, GLsizei stride, const GLvoid *ptr );
PDGL_API void pdglIndexPointer( GLenum type,GLsizei stride, const GLvoid *ptr );
PDGL_API void pdglTexCoordPointer( GLint size,GLenum type, GLsizei stride, const GLvoid *ptr );
...
PDGL_API void pdglDrawElements( GLenum mode,GLsizei count, GLenum type, const GLvoid *indices );
PDGL_API void pdglInterleavedArrays( GLenum format,GLsizei stride, const GLvoid *pointer );
...
PDGL_API void pdglLightfv(GLenum light,GLenum pname, const GLfloat *params);
...
PDGL_API void pdglMaterialfv(GLenum face, GLenum pname, const GLfloat *params);
PDGL_API void pdglGetMaterialfv(GLenum face,GLenum pname, GLfloat *params);
...
void pdglFrustum(float mx, float nx, float my, float ny, float mz, float nz);
...
PDGL_API void pdglTexEnvfv(GLenum target,GLenum pname, const GLfloat *params);
PDGL_API void pdglTexEnviv(GLenum target,GLenum pname, const GLint *params);
PDGL_API void pdglTexParameterf(GLenum target,GLenum pname, GLfloat param);
PDGL_API void pdglTexParameteri(GLenum target,GLenum pname, GLint param);
PDGL_API void pdglTexParameterfv(GLenum target,GLenum pname, const GLfloat *params);
PDGL_API void pdglTexParameteriv(GLenum target,GLenum pname, const GLint *params);
PDGL_API void pdglTexImage1D(GLenum target, GLint level,GLint internalFormat, GLsizei width, GLint border, GLenum format, GLenum type, const GLvoid *pixels);
PDGL_API void pdglTexImage2D(GLenum target, GLint level,GLint internalFormat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const GLvoid *pixels);
PDGL_API void pdglGetTexImage(GLenum target, GLint level,GLenum format, GLenum type, GLvoid *pixels);
PDGL_API void pdglCopyTexImage2D( GLenum target, GLint level,GLenum internalformat, GLint x, GLint y, GLsizei width, GLsizei height, GLint border );
...
BOOL pdwglCopyContext(HGLRC hglrc1, HGLRC hglrc2, UINT mask);
...
int pdwglChoosePixelFormat(HDC hdc, CONST PIXELFORMATDESCRIPTOR *ppfd);
int pdwglGetPixelFormat(HDC hdc);
BOOL pdwglSetPixelFormat(HDC hdc, INT iPixelFormat, const PIXELFORMATDESCRIPTOR *ppfd);
int pdwglDescribePixelFormat(HDC hdc, INT iPixelFormat, UINT nBytes, LPPIXELFORMATDESCRIPTOR ppfd);
