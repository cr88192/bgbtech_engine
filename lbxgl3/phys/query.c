...
LBXGL_Entity *lbxgl_entity_worldroot;

int LBXGL_Entity_SetWorld(LBXGL_Entity *ents)
{
	lbxgl_entity_worldroot=ents;
	return(0);
}

LBXGL_Entity *LBXGL_Entity_GetWorld()
{
	return(lbxgl_entity_worldroot);
}
