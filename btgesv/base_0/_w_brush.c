...
void BTGE_Brush_BuildFaces(BTGE_Brush *brush)
{
	...
	{
		np[k]=i;
		nv[k]=BTGE_Brush_BuildFace(brush, i,
			xyz+j*3, st+j*2, &nt[k]);
		if(!nv[k])continue;
		j+=nv[k];
		k++;
...
void BTGE_Brush_DestroyFaces(BTGE_Brush *brush)
{
...
int BTGE_Brush_CheckLineBrush(BTGE_Brush *brush, float *sv, float *ev)
{
	float tv0[3], tv1[3], tv2[3];
	float f, g;
	int i;
...
int BTGE_Brush_GetExtents(BTGE_Brush *brush, float *vec,
	float *rm, float *rn)
{
	float tv0[3], tv1[3], tv2[3];
	float f, g, m, n;
...
int BTGE_Brush_GetPlaneExtents(BTGE_Brush *brush, float *norm,
	float *rm, float *rn)
{
	float tv0[3], tv1[3], tv2[3];
	float f, g, m, n;
...
void BTGE_Brush_GetBBoxExtents(BTGE_Brush *brush, float *vec,
	float *rm, float *rn)
{
	float d0, d1;
	int i;
...
void BTGE_Brush_GetBBoxPlaneExtents(BTGE_Brush *brush, float *norm,
	float *rm, float *rn)
{
	float d0, d1;
	int i;
...
BTGE_Brush *BTGE_Brush_New(int num)
{
	BTGE_Brush *tmp;
...
BTGE_Brush *BTGE_Brush_MakeCubeExtents(float mx, float my, float mz,
...
BTGE_Brush *BTGE_Brush_MakeCube(float x, float y, float z,
...
int btge_brush_getsphere(dyt obj, float *org, float *rad)
{
	BTGE_Brush *tmp;
