...
#if 0
// BGBDY_API int dytfFixintP(dytf a)
{
...
// BGBDY_API dytf dytfPtrF(void *p)
{
	u64 l;
...
BGBDY_API dytf dytfString(char *str)
	{ return(dytfPtrF(dystring(str))); }
BGBDY_API dytf dytfSymbol(char *str)
	{ return(dytfPtrF(dysymbol(str))); }
BGBDY_API dytf dytfKeyword(char *str)
	{ return(dytfPtrF(dykeyword(str))); }
...
BGBDY_API bool dytfStringP(dytf a)
	{ return(dystringp(dytfUnwrap(a))); }
BGBDY_API bool dytfSymbolP(dytf a)
	{ return(dysymbolp(dytfUnwrap(a))); }
BGBDY_API bool dytfKeywordP(dytf a)
	{ return(dykeywordp(dytfUnwrap(a))); }

#if 0
// BGBDY_API bool dytfNullP(dytf a)
{
	u64 l;
	l=*(u64 *)(&a);
	if(!l)return(true);
...
// BGBDY_API bool dytfUndefinedP(dytf a)
{
	u64 l;
	l=*(u64 *)(&a);
...
#if 0
// BGBDY_API bool dytfEqqP(dytf a, dytf b)
{
	if((*(u64 *)(&a))==(*(u64 *)(&b)))return(true);
	return(false);
}

// BGBDY_API bool dytfNEqqP(dytf a, dytf b)
{
	if((*(u64 *)(&a))!=(*(u64 *)(&b)))return(true);
	return(false);
}
