...
typedef struct ExWAD_CachedFile_s ExWAD_CachedFile;
typedef struct ExWAD_File_s ExWAD_File;
...
struct ExWAD_CachedFile_s
{
ExWAD_CachedFile *next;		//next cached file
char *name;
byte *buffer;				//cached version of file
int sz_buffer;					//buffer size
int ucnt;					//use count
};
