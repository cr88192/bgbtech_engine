...
#define v2d_to_m128d(v)		_mm_loadu_pd((double *)(&(v)))
#define v4d_to_m128d2a(v)	_mm_loadu_pd(((double *)(&(v)))+0)
#define v4d_to_m128d2b(v)	_mm_loadu_pd(((double *)(&(v)))+2)

#define v2d_m128d(v)		_vec2d_m128d(v)
#define v4d_m128d2(u, v)	_vec4d_m128d2(u, v)
...
static vec2d _vec2d_m128d(__m128d m)
{
	vec2d t;
	_mm_storeu_pd((double *)(&t), m);
	return(t);
//	return(_vec2i(x[0], x[1]));
};

static vec4d _vec4d_m128d2(__m128d m, __m128d n)
{
	vec4d t;
	_mm_storeu_pd(((double *)(&t))+0, m);
	_mm_storeu_pd(((double *)(&t))+2, n);
	return(t);
//	return(_vec2i(x[0], x[1]));
};
...
static double v3ddot(vec3du a, vec3du b)
{
	vec3d c;
	c=v4d_m128d2(
		_mm_mul_pd(v4d_to_m128d2a(a), v4d_to_m128d2a(b)),
		_mm_mul_pd(v4d_to_m128d2b(a), v4d_to_m128d2b(b)));
	return(c.x+c.y+c.z);
...
{
	vec2d c;
	c=v2d_m128d(_mm_add_pd(v2d_to_m128d(a), v2d_to_m128d(b)));
...
{
	vec2d c;
	c=v2d_m128d(_mm_sub_pd(v2d_to_m128d(a), v2d_to_m128d(b)));
//	c.x=a.x-b.x; c.y=a.y-b.y;
	return(c);
}
...
{
	vec2d c;
	c=v2d_m128d(_mm_mul_pd(v2d_to_m128d(a), v2d_to_m128d(b)));
//	c.x=a.x*b.x; c.y=a.y*b.y;
	return(c);
}
...
{
	vec2d c;
	c=v2d_m128d(_mm_div_pd(v2d_to_m128d(a), v2d_to_m128d(b)));
//	c.x=a.x/b.x; c.y=a.y/b.y;
	return(c);
}
...
static vec3d v3dadd(vec3du a, vec3du b)
{
	vec3d c;
	c=v4d_m128d2(
		_mm_add_pd(v4d_to_m128d2a(a), v4d_to_m128d2a(b)),
		_mm_add_pd(v4d_to_m128d2b(a), v4d_to_m128d2b(b)));
...
static vec3d v3dsub(vec3du a, vec3du b)
{
	vec3d c;
	c=v4d_m128d2(
		_mm_sub_pd(v4d_to_m128d2a(a), v4d_to_m128d2a(b)),
		_mm_sub_pd(v4d_to_m128d2b(a), v4d_to_m128d2b(b)));
//	c.x=a.x-b.x; c.y=a.y-b.y; c.z=a.z-b.z;
	return(c);
}
...
static vec3d v3ddiv(vec3du a, vec3du b)
{
	vec3d c;
	c=v4d_m128d2(
		_mm_div_pd(v4d_to_m128d2a(a), v4d_to_m128d2a(b)),
		_mm_div_pd(v4d_to_m128d2b(a), v4d_to_m128d2b(b)));
//	c.x=a.x/b.x; c.y=a.y/b.y; c.z=a.z/b.z;
	return(c);
}
