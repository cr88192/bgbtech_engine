...
{
	if(dyFormIsP(ty, "getindex"))
	{
		return(dycadr(ty));
	}

	if(dyFormIsP(ty, "emptyindex"))
	{
		return(dycadr(ty));
	}
...
int BSVMC_CompileBinary(BSVM_SVMCState *ctx, dyt l)
{
	...
	ln=BSVMC_ReduceExpr(ctx, dycadr(l));
	rn=BSVMC_ReduceExpr(ctx, dycaddr(l));
	...
	if(BSVMC_TypeSmallIntP(ctx, lt) && dyintp(rn))
	{
		...
		if(dyFormIsP(l, "+"))i=BSVM_SOP_ADD_XI_C;
		if(dyFormIsP(l, "-"))i=BSVM_SOP_SUB_XI_C;
		if(dyFormIsP(l, "*"))i=BSVM_SOP_MUL_XI_C;
		if(dyFormIsP(l, "/"))i=BSVM_SOP_DIV_XI_C;
		...
		if(dyFormIsP(l, "<<"))i=BSVM_SOP_SHL_XI_C;
		if(dyFormIsP(l, ">>"))i=BSVM_SOP_SHR_XI_C;
		if(dyFormIsP(l, ">>>"))i=BSVM_SOP_SHR_XI_C;
	...
	if(BSVMC_TypeLongP(ctx, lt) && dylongp(rn))
	{
		...
		if(dyFormIsP(l, "+"))i=BSVM_SOP_ADD_XL_C;
		if(dyFormIsP(l, "-"))i=BSVM_SOP_SUB_XL_C;
		if(dyFormIsP(l, "*"))i=BSVM_SOP_MUL_XL_C;
		if(dyFormIsP(l, "/"))i=BSVM_SOP_DIV_XL_C;

		if(i>0)
		{
			BSVMC_CompileExpr(ctx, ln);
			BSVMC_EmitOp(ctx, i);
			BSVMC_EncSVLI(ctx, dylongv(rn));
			return(1);
		}

		if(dyFormIsP(l, "<<"))i=BSVM_SOP_SHL_XL_C;
		if(dyFormIsP(l, ">>"))i=BSVM_SOP_SHR_XL_C;
		if(dyFormIsP(l, ">>>"))i=BSVM_SOP_SHR_XL_C;
		...
		if(i>0)
		{
			BSVMC_CompileExpr(ctx, ln);
			BSVMC_EmitOp(ctx, i);
			BSVMC_EncByte(ctx, dylongv(rn));
			return(1);
		}
	}

	if(dyintp(ln) && BSVMC_TypeSmallIntP(ctx, rt))
	{
		i=-1;
		...
		if(i>0)
		{
			...
			BSVMC_EmitOp(ctx, i);
			BSVMC_EncSVLI(ctx, dyintv(ln));
			return(1);
		}
	}

	if(dylongp(ln) && BSVMC_TypeLongP(ctx, rt))
	{
		i=-1;
...
//	if((lt==rt) && BSVMC_TypeSmallIntP(ctx, lt))
		...
		BSVMC_TypeSmallIntP(ctx, rt))
	{
		...
		if(dyFormIsP(l, "+"))i=BSVM_SOP_ADD_XI;
		if(dyFormIsP(l, "-"))i=BSVM_SOP_SUB_XI;
		if(dyFormIsP(l, "*"))i=BSVM_SOP_MUL_XI;
		if(dyFormIsP(l, "/"))i=BSVM_SOP_DIV_XI;
		if(dyFormIsP(l, "\\"))i=BSVM_SOP_DIV_XI;
		if(dyFormIsP(l, "%"))i=BSVM_SOP_MOD_XI;
		if(dyFormIsP(l, "&"))i=BSVM_SOP_AND_XI;
		if(dyFormIsP(l, "|"))i=BSVM_SOP_OR_XI;
		if(dyFormIsP(l, "^"))i=BSVM_SOP_XOR_XI;
		if(dyFormIsP(l, "<<"))i=BSVM_SOP_SHL_XI;
		if(dyFormIsP(l, ">>"))i=BSVM_SOP_SHR_XI;
		if(dyFormIsP(l, ">>>"))i=BSVM_SOP_SHR_XI;
//		if(dyFormIsP(l, "**"))i=BSVM_SOP_EXP_XI;

		if(dyFormIsP(l, "<"))i=BSVM_SOP_CMP_LT_XI;
		if(dyFormIsP(l, ">"))i=BSVM_SOP_CMP_GT_XI;
		if(dyFormIsP(l, "<="))i=BSVM_SOP_CMP_LE_XI;
		if(dyFormIsP(l, ">="))i=BSVM_SOP_CMP_GE_XI;
		if(dyFormIsP(l, "=="))i=BSVM_SOP_CMP_EQ_XI;
		if(dyFormIsP(l, "!="))i=BSVM_SOP_CMP_NE_XI;
		if(dyFormIsP(l, "==="))i=BSVM_SOP_CMP_EQ_XI;
		if(dyFormIsP(l, "!=="))i=BSVM_SOP_CMP_NE_XI;

		if(i<0)return(0);

		if(lc && rc && dyeqp(ln, rn))
		{
			BSVMC_CompileExpr(ctx, ln);
		...
		BSVMC_TypeSmallLongP(ctx, rt))
	{
		...
		if(dyFormIsP(l, "+"))i=BSVM_SOP_ADD_XL;
		if(dyFormIsP(l, "-"))i=BSVM_SOP_SUB_XL;
		if(dyFormIsP(l, "*"))i=BSVM_SOP_MUL_XL;
		if(dyFormIsP(l, "/"))i=BSVM_SOP_DIV_XL;
		if(dyFormIsP(l, "\\"))i=BSVM_SOP_DIV_XL;
		if(dyFormIsP(l, "%"))i=BSVM_SOP_MOD_XL;
		if(dyFormIsP(l, "&"))i=BSVM_SOP_AND_XL;
		if(dyFormIsP(l, "|"))i=BSVM_SOP_OR_XL;
		if(dyFormIsP(l, "^"))i=BSVM_SOP_XOR_XL;
		if(dyFormIsP(l, "<<"))i=BSVM_SOP_SHL_XL;
		if(dyFormIsP(l, ">>"))i=BSVM_SOP_SHR_XL;
		if(dyFormIsP(l, ">>>"))i=BSVM_SOP_SHR_XL;
//		if(dyFormIsP(l, "**"))i=BSVM_SOP_EXP_XL;

		if(dyFormIsP(l, "<"))i=BSVM_SOP_CMP_LT_XL;
		if(dyFormIsP(l, ">"))i=BSVM_SOP_CMP_GT_XL;
		if(dyFormIsP(l, "<="))i=BSVM_SOP_CMP_LE_XL;
		if(dyFormIsP(l, ">="))i=BSVM_SOP_CMP_GE_XL;
		if(dyFormIsP(l, "=="))i=BSVM_SOP_CMP_EQ_XL;
		if(dyFormIsP(l, "!="))i=BSVM_SOP_CMP_NE_XL;
		if(dyFormIsP(l, "==="))i=BSVM_SOP_CMP_EQ_XL;
		if(dyFormIsP(l, "!=="))i=BSVM_SOP_CMP_NE_XL;
		...
		BSVMC_TypeSmallFloatP(ctx, rt))
	{
		...
		if(dyFormIsP(l, "+"))i=BSVM_SOP_ADD_XF;
		if(dyFormIsP(l, "-"))i=BSVM_SOP_SUB_XF;
		if(dyFormIsP(l, "*"))i=BSVM_SOP_MUL_XF;
		if(dyFormIsP(l, "/"))i=BSVM_SOP_DIV_XF;

		if(dyFormIsP(l, "<"))i=BSVM_SOP_CMP_LT_XF;
		if(dyFormIsP(l, ">"))i=BSVM_SOP_CMP_GT_XF;
		if(dyFormIsP(l, "<="))i=BSVM_SOP_CMP_LE_XF;
		if(dyFormIsP(l, ">="))i=BSVM_SOP_CMP_GE_XF;
		if(dyFormIsP(l, "=="))i=BSVM_SOP_CMP_EQ_XF;
		if(dyFormIsP(l, "!="))i=BSVM_SOP_CMP_NE_XF;
		if(dyFormIsP(l, "==="))i=BSVM_SOP_CMP_EQ_XF;
		if(dyFormIsP(l, "!=="))i=BSVM_SOP_CMP_NE_XF;
		...
		BSVMC_TypeSmallDoubleP(ctx, rt))
	{
		...
		if(dyFormIsP(l, "+"))i=BSVM_SOP_ADD_XD;
		if(dyFormIsP(l, "-"))i=BSVM_SOP_SUB_XD;
		if(dyFormIsP(l, "*"))i=BSVM_SOP_MUL_XD;
		if(dyFormIsP(l, "/"))i=BSVM_SOP_DIV_XD;

		if(dyFormIsP(l, "<"))i=BSVM_SOP_CMP_LT_XD;
		if(dyFormIsP(l, ">"))i=BSVM_SOP_CMP_GT_XD;
		if(dyFormIsP(l, "<="))i=BSVM_SOP_CMP_LE_XD;
		if(dyFormIsP(l, ">="))i=BSVM_SOP_CMP_GE_XD;
		if(dyFormIsP(l, "=="))i=BSVM_SOP_CMP_EQ_XD;
		if(dyFormIsP(l, "!="))i=BSVM_SOP_CMP_NE_XD;
		if(dyFormIsP(l, "==="))i=BSVM_SOP_CMP_EQ_XD;
		if(dyFormIsP(l, "!=="))i=BSVM_SOP_CMP_NE_XD;
...
//	if((lt==rt) && (lt==dykeyword("fixnum")))
	if((lt==rt) && BSVMC_TypeSmallFixIntP(ctx, lt))
	{
		i=-1;

		if(dyFormIsP(l, "+"))i=BSVM_SOP_ADD_FN;
		if(dyFormIsP(l, "-"))i=BSVM_SOP_SUB_FN;
		if(dyFormIsP(l, "*"))i=BSVM_SOP_MUL_FN;
		if(dyFormIsP(l, "/"))i=BSVM_SOP_DIV_FN;
		if(dyFormIsP(l, "\\"))i=BSVM_SOP_IDIV_FN;
		if(dyFormIsP(l, "%"))i=BSVM_SOP_MOD_FN;
		if(dyFormIsP(l, "&"))i=BSVM_SOP_AND_FN;
		if(dyFormIsP(l, "|"))i=BSVM_SOP_OR_FN;
		if(dyFormIsP(l, "^"))i=BSVM_SOP_XOR_FN;

		if(dyFormIsP(l, "<<"))i=BSVM_SOP_SHL_FN;
		if(dyFormIsP(l, ">>"))i=BSVM_SOP_SHR_FN;
		if(dyFormIsP(l, ">>>"))i=BSVM_SOP_SHR_FN;
		if(dyFormIsP(l, "**"))i=BSVM_SOP_EXP_FN;

		if(dyFormIsP(l, "<"))i=BSVM_SOP_CMP_L_FN;
		if(dyFormIsP(l, ">"))i=BSVM_SOP_CMP_G_FN;
		if(dyFormIsP(l, "<="))i=BSVM_SOP_CMP_LE_FN;
		if(dyFormIsP(l, ">="))i=BSVM_SOP_CMP_GE_FN;
		if(dyFormIsP(l, "=="))i=BSVM_SOP_CMP_E_FN;
		if(dyFormIsP(l, "!="))i=BSVM_SOP_CMP_NE_FN;
		if(dyFormIsP(l, "==="))i=BSVM_SOP_CMP_E_FN;
		if(dyFormIsP(l, "!=="))i=BSVM_SOP_CMP_NE_FN;
...
#if 0
		if((i==BSVM_SOP_EXP_FN) && dyintp(rn))
		{
			j=dyintv(rn);
			if(!j)
			{
...
//	if(i && j)
		...
		BSVMC_TypeSmallFixRealP(ctx, rt))
	{
		...
		if(dyFormIsP(l, "+"))i=BSVM_SOP_ADD_FL;
		if(dyFormIsP(l, "-"))i=BSVM_SOP_SUB_FL;
		if(dyFormIsP(l, "*"))i=BSVM_SOP_MUL_FL;
		if(dyFormIsP(l, "/"))i=BSVM_SOP_DIV_FL;

		if(dyFormIsP(l, "<"))i=BSVM_SOP_CMP_L_FL;
		if(dyFormIsP(l, ">"))i=BSVM_SOP_CMP_G_FL;
		if(dyFormIsP(l, "<="))i=BSVM_SOP_CMP_LE_FL;
		if(dyFormIsP(l, ">="))i=BSVM_SOP_CMP_GE_FL;
		if(dyFormIsP(l, "=="))i=BSVM_SOP_CMP_E_FL;
		if(dyFormIsP(l, "!="))i=BSVM_SOP_CMP_NE_FL;
...
//		if(rt==dykeyword("int"))
	...
	i=-1;
	if(dyFormIsP(l, "+"))i=BSVM_SOP_ADD;
	if(dyFormIsP(l, "-"))i=BSVM_SOP_SUB;
	if(dyFormIsP(l, "*"))i=BSVM_SOP_MUL;
	if(dyFormIsP(l, "/"))i=BSVM_SOP_DIV;
	if(dyFormIsP(l, "%"))i=BSVM_SOP_MOD;
	if(dyFormIsP(l, "&"))i=BSVM_SOP_AND;
	if(dyFormIsP(l, "|"))i=BSVM_SOP_OR;
	if(dyFormIsP(l, "^"))i=BSVM_SOP_XOR;
...
int BSVMC_CompileBinaryExpr(BSVM_SVMCState *ctx, dyt l)
{
	...
	i=BSVMC_CompileBinary(ctx, dycdr(l));
	if(i)return(i);
	...
	if(dycadr(l)==dysymbol("+."))i=BSVM_OPR_DADD;
	if(dycadr(l)==dysymbol("-."))i=BSVM_OPR_DSUB;
	if(dycadr(l)==dysymbol("*."))i=BSVM_OPR_DMUL;
	if(dycadr(l)==dysymbol("/."))i=BSVM_OPR_DDIV;
	if(dycadr(l)==dysymbol("\\."))i=BSVM_OPR_DIDIV;
	if(dycadr(l)==dysymbol("%."))i=BSVM_OPR_DMOD;
	if(dycadr(l)==dysymbol("&."))i=BSVM_OPR_DAND;
	if(dycadr(l)==dysymbol("|."))i=BSVM_OPR_DOR;
	if(dycadr(l)==dysymbol("^."))i=BSVM_OPR_DXOR;
	...
	dyt ln, dyt rn)
{
	...
	if(lt==rt)BSVMC_CompileUnaryTypePrefix(ctx, lt);
}
...
int BSVMC_CompileUnaryExpr(BSVM_SVMCState *ctx, dyt l)
{
	...
	if(dycadr(l)==dysymbol("&"))
	{
		...
		if(dyFormIsP(t, "getindex"))
		{
			BSVMC_CompileExpr(ctx, dycadr(t));
			BSVMC_CompileExpr(ctx, dycaddr(t));
			BSVMC_EmitOp(ctx, BSVM_SOP_LOADINDEXA);
			return(1);
		}
		if(dyFormIsP(t, "objref"))
		{
			BSVMC_CompileExpr(ctx, dycadr(t));
//			BSVMC_EmitOp(ctx, BSVM_SOP_PUSH);
//			BSVMC_EncIndexLit(ctx, dycaddr(t));
//			BSVMC_EmitOp(ctx, BSVM_SOP_LOADINDEXA);
	...
	if(dycadr(l)==dysymbol("&&"))
	{
		...
		if(dysymbolp(t))
		{
			...
			BSVMC_EmitJmpAddr(ctx, dysymbolv(t));
			return(1);
		}
	}

	n=BSVMC_ReduceExpr(ctx, dycaddr(l));
...
void BSVMC_CompileGetIndexTypePrefix(BSVM_SVMCState *ctx, dyt l)
{
	...
	t2=BSVMC_InferExpr(ctx, dycaddr(l));
...
//	nv=dycadddr(l);
	...
	na=BSVMC_ReduceExpr(ctx, dycadr(l));
	ni=BSVMC_ReduceExpr(ctx, dycaddr(l));
	nv=BSVMC_ReduceExpr(ctx, dycadddr(l));
...
//	if(!ta)return(0);
	...
	if(ta && BSVMC_TypeSmallIntP(ctx, ta))
	{
		i=BSVM_SOP_PF_HINT_XI;
