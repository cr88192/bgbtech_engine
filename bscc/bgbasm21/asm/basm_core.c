...
BASM2_API void BASM_ModRM(BASM_Context *ctx, int reg,
	int rm, int sc, int idx, int disp, char *lbl)
{
...
BASM2_API char *BASM_OutImm(BASM_Context *ctx, char *s,
...
BASM2_API char *BASM_OutModRM(BASM_Context *ctx, char *s, int reg,
...
BASM2_API void BASM_OutOpStrMem(BASM_Context *ctx, char *s,
...
BASM2_API void BASM_OutOpStrRegImm(BASM_Context *ctx, char *s, int reg,
	long long imm, char *lbl)
{
	int i;
...
BASM2_API void BASM_OutOpStrRegMem(BASM_Context *ctx, char *s, int reg,
	char *lbl, int breg, int ireg, int sc, int disp)
{
	int i;
...
BASM2_API void BASM_OutOpStrMemImm(BASM_Context *ctx, char *s, int w,
	char *lbl, int breg, int ireg, int sc, int disp,
...
BASM2_API void BASM_OutOpStrRegRegImm(BASM_Context *ctx, char *s,
...
BASM2_API void BASM_OutOpStrRegMemImm(BASM_Context *ctx, char *s, int reg,
	char *lbl, int breg, int ireg, int sc, int disp,
	long long imm, char *lbl2)
{
	int i;
...
BASM2_API void BASM_OutOpStrRegRegReg(BASM_Context *ctx, char *s,
...
BASM2_API void BASM_OutOpStrRegMemReg(BASM_Context *ctx, char *s, int reg,
...
BASM2_API void BASM_OutOpImm(BASM_Context *ctx, int op, int w,
	long long imm, char *lbl)
{
	int i;
...
BASM2_API void BASM_OutOpMem(BASM_Context *ctx, int op, int w,
...
BASM2_API void BASM_OutOpRegImm(BASM_Context *ctx, int op,
...
BASM2_API void BASM_OutOpRegMem(BASM_Context *ctx, int op, int reg,
	char *lbl, int breg, int ireg, int sc, long long disp)
{
	int i, j;
...
BASM2_API void BASM_OutOpMemReg(BASM_Context *ctx, int op, int reg,
	char *lbl, int breg, int ireg, int sc, long long disp)
{
	int i, j;
...
BASM2_API void BASM_OutOpMemImm(BASM_Context *ctx, int op, int w,
	char *lbl, int breg, int ireg, int sc, long long disp,
	long long imm, char *lbl2)
{
	int i;
...
BASM2_API void BASM_OutOpRegRegImm(BASM_Context *ctx, int op, int r0, int r1,
	long long imm, char *lbl2)
{
	int i, j;
...
BASM2_API void BASM_OutOpRegMemImm(BASM_Context *ctx, int op, int reg,
	char *lbl, int breg, int ireg, int sc, long long disp,
	long long imm, char *lbl2)
{
	int i, j;
...
BASM2_API void BASM_OutOpMemRegImm(BASM_Context *ctx, int op, int reg,
	char *lbl, int breg, int ireg, int sc, long long disp,
	long long imm, char *lbl2)
{
	int i, j;
...
BASM2_API void BASM_OutOpRegMemReg(BASM_Context *ctx, int op, int reg,
	char *lbl, int breg, int ireg, int sc, long long disp,
	int reg2)
{
	int i, j;
...
BASM2_API void BASM_OutOpMemRegReg(BASM_Context *ctx, int op, int reg,
	char *lbl, int breg, int ireg, int sc, long long disp,
	int reg2)
{
	int i, j;
...
BASM2_API void BASM_OutOpGeneric1(BASM_Context *ctx, int op, int w,
	char *lbl, int breg, int ireg, int sc, long long disp)
{
	if(sc)
	{
...
BASM2_API void BASM_OutOpGeneric2(BASM_Context *ctx, int op, int w,
...
BASM2_API void BASM_OutOpGeneric3(BASM_Context *ctx, int op, int w,
	char *lbl0, int breg0, int ireg0, int sc0, long long disp0,
	char *lbl1, int breg1, int ireg1, int sc1, long long disp1,
