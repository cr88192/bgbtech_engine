...
BASM2_API void BASM_ResetCtx(BASM_Context *ctx)
{
	int i;
...
BASM2_API void BASM_CopyLblCtx(BASM_Context *ctx)
{
	int i;
...
BASM2_API void BASM_AssembleCtxBuf(BASM_Context *ctx, char *buf)
{
...
BASM2_API void BASM_AssembleCtxBufFast(BASM_Context *ctx, char *buf)
{
	int i, j;
