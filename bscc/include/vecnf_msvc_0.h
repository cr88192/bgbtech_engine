...
#define v2zero()	_mm_setzero_ps()
#define v3zero()	_mm_setzero_ps()
#define v4zero()	_mm_setzero_ps()
#define qzero()		_mm_setzero_ps()
...
static vec2 v2abs(vec2 a)
	{ vec2 t; t=_mm_and_ps(a, _mm_set1_epi32(0x7FFFFFFF)); return(t); };
static vec3 v3abs(vec3 a)
	{ vec3 t; t=_mm_and_ps(a, _mm_set1_epi32(0x7FFFFFFF)); return(t); };
static vec4 v4abs(vec4 a)
	{ vec4 t; t=_mm_and_ps(a, _mm_set1_epi32(0x7FFFFFFF)); return(t); };
static quat qabs(quat a)
	{ quat t; t=_mm_and_ps(a, _mm_set1_epi32(0x7FFFFFFF)); return(t); };
