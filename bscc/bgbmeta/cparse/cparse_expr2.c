...
//			n2=BCCX_New("symbol"); BCCX_Set(n2, "name", b2);
			...
			n=BCCX_New1("offsetof", BCCX_New1("tyexpr", n1));
			BCCX_Set(n, "name", b);
...
BCCX_Node *BGBCP_IfExpr(BCCX_Node *cond, BCCX_Node *ln, BCCX_Node *rn)
{
	...
	if(ln && rn)
	{
		n1=BCCX_New1("then", ln);
		n2=BCCX_New1("else", rn);
		n3=BCCX_New1("cond", cond);
	...
	{
		n1=BCCX_New1("then", rn);
		n2=BGBCP_UnaryExpr("!", cond);
		n3=BCCX_New1("cond", n2);
		n=BCCX_New2("if", n3, n1);
	}else
	{
		n=NULL;
