...
#define FR2C_OP_JCMP_LZI		0x34	//Jump-Compare Local Zero Int
#define FR2C_OP_JCMP_LZL		0x35	//Jump-Compare Local Zero Long
#define FR2C_OP_JCMP_LZF		0x36	//Jump-Compare Local Zero Float
#define FR2C_OP_JCMP_LZD		0x37	//Jump-Compare Local Zero Double
#define FR2C_OP_JCMP_AZI		0x38	//Jump-Compare Arg Zero Int
#define FR2C_OP_JCMP_AZL		0x39	//Jump-Compare Arg Zero Long
#define FR2C_OP_JCMP_AZF		0x3A	//Jump-Compare Arg Zero Float
#define FR2C_OP_JCMP_AZD		0x3B	//Jump-Compare Arg Zero Double
