...
//			t=cs.getub_npp();
		...
		case FR2C_OP_UNOPW_IC:
			cs.ninc(); j=cs.getub_npp();
			d=cs.getub_npp(); l=cs.getuw24_npp();
			return FrUnOpImm.makeUnOpImm(FR2C_TY_I, j&15,
				(j>>4)&15, d, (long)img.getLiteralInt(l));
		case FR2C_OP_UNOPW_LC:
			cs.ninc(); j=cs.getub_npp();
			d=cs.getub_npp(); l=cs.getuw24_npp();
			return FrUnOpImm.makeUnOpImm(FR2C_TY_L, j&15,
				(j>>4)&15, d, img.getLiteralLong(l));
		case FR2C_OP_UNOPW_FC:
			cs.ninc(); j=cs.getub_npp();
			d=cs.getub_npp(); l=cs.getuw24_npp();
			return FrUnOpImm.makeUnOpImm(FR2C_TY_F, j&15,
				(j>>4)&15, d, (double)img.getLiteralFloat(l));
		case FR2C_OP_UNOPW_DC:
			cs.ninc(); j=cs.getub_npp();
			d=cs.getub_npp(); l=cs.getuw24_npp();
			return FrUnOpImm.makeUnOpImm(FR2C_TY_D, j&15,
				(j>>4)&15, d, img.getLiteralDouble(l));
		...
		case FR2C_OP_CMPW_I:
			cs.ninc(); j=cs.getub_npp(); d=cs.getub_npp();
			s=cs.getub_npp();	t=cs.getub_npp();
			return FrCmpOp.makeCmpOp(FR2C_TY_I, j&15,
				(j>>4)&15, d, s, t);
		case FR2C_OP_CMPW_L:
			cs.ninc(); j=cs.getub_npp(); d=cs.getub_npp();
			s=cs.getub_npp();	t=cs.getub_npp();
			return FrCmpOp.makeCmpOp(FR2C_TY_L, j&15,
				(j>>4)&15, d, s, t);
		case FR2C_OP_CMPW_F:
			cs.ninc(); j=cs.getub_npp(); d=cs.getub_npp();
			s=cs.getub_npp();	t=cs.getub_npp();
			return FrCmpOp.makeCmpOp(FR2C_TY_F, j&15,
				(j>>4)&15, d, s, t);
		case FR2C_OP_CMPW_D:
			cs.ninc(); j=cs.getub_npp(); d=cs.getub_npp();
			s=cs.getub_npp();	t=cs.getub_npp();
			return FrCmpOp.makeCmpOp(FR2C_TY_D, j&15,
				(j>>4)&15, d, s, t);

		case FR2C_OP_CMPW_IC:
			cs.ninc(); j=cs.getub_npp();
			d=cs.getub_npp(); s=cs.getub_npp(); t=cs.getuw24_npp();
			return FrCmpOpImm.makeCmpOpImm(FR2C_TY_I, j&15,
					(j>>4)&15, d, s, (long)img.getLiteralInt(t));
		case FR2C_OP_CMPW_LC:
			cs.ninc(); j=cs.getub_npp();
			d=cs.getub_npp(); s=cs.getub_npp(); t=cs.getuw24_npp();
			return FrCmpOpImm.makeCmpOpImm(FR2C_TY_L, j&15,
					(j>>4)&15, d, s, img.getLiteralLong(t));
		case FR2C_OP_CMPW_FC:
			cs.ninc(); j=cs.getub_npp();
			d=cs.getub_npp(); s=cs.getub_npp(); t=cs.getuw24_npp();
			return FrCmpOpImm.makeCmpOpImm(FR2C_TY_F, j&15,
					(j>>4)&15, d, s, (double)img.getLiteralFloat(t));
		case FR2C_OP_CMPW_DC:
			cs.ninc(); j=cs.getub_npp();
			d=cs.getub_npp(); s=cs.getub_npp(); t=cs.getuw24_npp();
			return FrCmpOpImm.makeCmpOpImm(FR2C_TY_D, j&15,
					(j>>4)&15, d, s, img.getLiteralDouble(t));
		...
		case FR2C_OP_LOADINDEX_IC:
			cs.ninc(); j=cs.getub_npp();
			k=cs.getub_npp(); l=cs.getub_npp();
			return FrOpLoadIndexC.makeOpLoadIndexC(FR2C_TY_I, (j>>4)&15,
				j&15, (k>>4)&15, (((k&15)<<8)|l));
		case FR2C_OP_LOADINDEX_LC:
			cs.ninc(); j=cs.getub_npp();
			k=cs.getub_npp(); l=cs.getub_npp();
			return FrOpLoadIndexC.makeOpLoadIndexC(FR2C_TY_L, (j>>4)&15,
				j&15, (k>>4)&15, (((k&15)<<8)|l));
		case FR2C_OP_LOADINDEX_FC:
			cs.ninc(); j=cs.getub_npp();
			k=cs.getub_npp(); l=cs.getub_npp();
			return FrOpLoadIndexC.makeOpLoadIndexC(FR2C_TY_F, (j>>4)&15,
				j&15, (k>>4)&15, (((k&15)<<8)|l));
		case FR2C_OP_LOADINDEX_DC:
			cs.ninc(); j=cs.getub_npp();
			k=cs.getub_npp(); l=cs.getub_npp();
			return FrOpLoadIndexC.makeOpLoadIndexC(FR2C_TY_D, (j>>4)&15,
				j&15, (k>>4)&15, (((k&15)<<8)|l));
		case FR2C_OP_LOADINDEX_SBC:
			cs.ninc(); j=cs.getub_npp();
			k=cs.getub_npp(); l=cs.getub_npp();
			return FrOpLoadIndexC.makeOpLoadIndexC(FR2C_TY_SB, (j>>4)&15,
				j&15, (k>>4)&15, (((k&15)<<8)|l));
		...
		case FR2C_OP_LOADINDEX_SSC:
			cs.ninc(); j=cs.getub_npp();
			k=cs.getub_npp(); l=cs.getub_npp();
			return FrOpLoadIndexC.makeOpLoadIndexC(FR2C_TY_SS, (j>>4)&15,
				j&15, (k>>4)&15, (((k&15)<<8)|l));
		...
		case FR2C_OP_LOADINDEX_PC:
			cs.ninc(); j=cs.getub_npp();
			k=cs.getub_npp(); l=cs.getub_npp();
			return FrOpLoadIndexC.makeOpLoadIndexC(FR2C_TY_P, (j>>4)&15,
				j&15, (k>>4)&15, (((k&15)<<8)|l));

		case FR2C_OP_STOREINDEX_I:
			cs.ninc(); j=cs.getub_npp(); k=cs.getub_npp();
			return FrOpStoreIndex.makeOpStoreIndex(FR2C_TY_I,
				(j>>4)&15, j&15, (k>>4)&15, k&15);
		case FR2C_OP_STOREINDEX_L:
			cs.ninc(); j=cs.getub_npp(); k=cs.getub_npp();
			return FrOpStoreIndex.makeOpStoreIndex(FR2C_TY_L,
				(j>>4)&15, j&15, (k>>4)&15, k&15);
		case FR2C_OP_STOREINDEX_F:
			cs.ninc(); j=cs.getub_npp(); k=cs.getub_npp();
			return FrOpStoreIndex.makeOpStoreIndex(FR2C_TY_F,
				(j>>4)&15, j&15, (k>>4)&15, k&15);
		case FR2C_OP_STOREINDEX_D:
			cs.ninc(); j=cs.getub_npp(); k=cs.getub_npp();
			return FrOpStoreIndex.makeOpStoreIndex(FR2C_TY_D,
				(j>>4)&15, j&15, (k>>4)&15, k&15);
//		case FR2C_OP_STOREINDEX_SB:
		case FR2C_OP_STOREINDEX_B:
			cs.ninc(); j=cs.getub_npp(); k=cs.getub_npp();
			return FrOpStoreIndex.makeOpStoreIndex(FR2C_TY_SB,
				(j>>4)&15, j&15, (k>>4)&15, k&15);
//		case FR2C_OP_STOREINDEX_UB:
//			cs.ninc(); j=cs.getub_npp(); k=cs.getub_npp();
//			return FrOpStoreIndex.makeOpStoreIndex(FR2C_TY_UB,
//				(j>>4)&15, j&15, (k>>4)&15, k&15);
//		case FR2C_OP_STOREINDEX_SS:
		case FR2C_OP_STOREINDEX_S:
			cs.ninc(); j=cs.getub_npp(); k=cs.getub_npp();
			return FrOpStoreIndex.makeOpStoreIndex(FR2C_TY_SS,
				(j>>4)&15, j&15, (k>>4)&15, k&15);
//		case FR2C_OP_STOREINDEX_US:
//			cs.ninc(); j=cs.getub_npp(); k=cs.getub_npp();
//			return FrOpStoreIndex.makeOpStoreIndex(FR2C_TY_US,
//				(j>>4)&15, j&15, (k>>4)&15, k&15);
		case FR2C_OP_STOREINDEX_P:
			cs.ninc(); j=cs.getub_npp(); k=cs.getub_npp();
			return FrOpStoreIndex.makeOpStoreIndex(FR2C_TY_P,
				(j>>4)&15, j&15, (k>>4)&15, k&15);

		case FR2C_OP_STOREINDEX_IC:
			cs.ninc(); j=cs.getub_npp();
			k=cs.getub_npp(); l=cs.getub_npp();
			return FrOpStoreIndexC.makeOpStoreIndexC(FR2C_TY_I, (j>>4)&15,
				j&15, (k>>4)&15, (((k&15)<<8)|l));
		case FR2C_OP_STOREINDEX_LC:
			cs.ninc(); j=cs.getub_npp();
			k=cs.getub_npp(); l=cs.getub_npp();
			return FrOpStoreIndexC.makeOpStoreIndexC(FR2C_TY_L, (j>>4)&15,
				j&15, (k>>4)&15, (((k&15)<<8)|l));
		case FR2C_OP_STOREINDEX_FC:
			cs.ninc(); j=cs.getub_npp();
			k=cs.getub_npp(); l=cs.getub_npp();
			return FrOpStoreIndexC.makeOpStoreIndexC(FR2C_TY_F, (j>>4)&15,
				j&15, (k>>4)&15, (((k&15)<<8)|l));
		case FR2C_OP_STOREINDEX_DC:
			cs.ninc(); j=cs.getub_npp();
			k=cs.getub_npp(); l=cs.getub_npp();
			return FrOpStoreIndexC.makeOpStoreIndexC(FR2C_TY_D, (j>>4)&15,
				j&15, (k>>4)&15, (((k&15)<<8)|l));
		case FR2C_OP_STOREINDEX_BC:
			cs.ninc(); j=cs.getub_npp();
			k=cs.getub_npp(); l=cs.getub_npp();
			return FrOpStoreIndexC.makeOpStoreIndexC(FR2C_TY_SB, (j>>4)&15,
				j&15, (k>>4)&15, (((k&15)<<8)|l));
		case FR2C_OP_STOREINDEX_SC:
			cs.ninc(); j=cs.getub_npp();
			k=cs.getub_npp(); l=cs.getub_npp();
			return FrOpStoreIndexC.makeOpStoreIndexC(FR2C_TY_SS, (j>>4)&15,
				j&15, (k>>4)&15, (((k&15)<<8)|l));
		case FR2C_OP_STOREINDEX_PC:
			cs.ninc(); j=cs.getub_npp();
			k=cs.getub_npp(); l=cs.getub_npp();
			return FrOpStoreIndexC.makeOpStoreIndexC(FR2C_TY_P, (j>>4)&15,
				j&15, (k>>4)&15, (((k&15)<<8)|l));


		case FR2C_OP_LEA_I:
			cs.ninc(); j=cs.getub_npp(); k=cs.getub_npp();
			return FrOpLea.makeOpLea(FR2C_TY_I,
				(j>>4)&15, j&15, (k>>4)&15, k&15);
		case FR2C_OP_LEA_L:
			cs.ninc(); j=cs.getub_npp(); k=cs.getub_npp();
			return FrOpLea.makeOpLea(FR2C_TY_L,
				(j>>4)&15, j&15, (k>>4)&15, k&15);
		case FR2C_OP_LEA_F:
			cs.ninc(); j=cs.getub_npp(); k=cs.getub_npp();
			return FrOpLea.makeOpLea(FR2C_TY_F,
				(j>>4)&15, j&15, (k>>4)&15, k&15);
		case FR2C_OP_LEA_D:
			cs.ninc(); j=cs.getub_npp(); k=cs.getub_npp();
			return FrOpLea.makeOpLea(FR2C_TY_D,
				(j>>4)&15, j&15, (k>>4)&15, k&15);
		case FR2C_OP_LEA_B:
			cs.ninc(); j=cs.getub_npp(); k=cs.getub_npp();
			return FrOpLea.makeOpLea(FR2C_TY_SB,
				(j>>4)&15, j&15, (k>>4)&15, k&15);
		case FR2C_OP_LEA_S:
			cs.ninc(); j=cs.getub_npp(); k=cs.getub_npp();
			return FrOpLea.makeOpLea(FR2C_TY_SS,
				(j>>4)&15, j&15, (k>>4)&15, k&15);
		case FR2C_OP_LEA_P:
			cs.ninc(); j=cs.getub_npp(); k=cs.getub_npp();
			return FrOpLea.makeOpLea(FR2C_TY_P,
				(j>>4)&15, j&15, (k>>4)&15, k&15);

		case FR2C_OP_LEA_IC:
			cs.ninc(); j=cs.getub_npp();
			k=cs.getub_npp(); l=cs.getub_npp();
			return FrOpLeaC.makeOpLeaC(FR2C_TY_I, (j>>4)&15,
				j&15, (k>>4)&15, (((k&15)<<8)|l));
		case FR2C_OP_LEA_LC:
			cs.ninc(); j=cs.getub_npp();
			k=cs.getub_npp(); l=cs.getub_npp();
			return FrOpLeaC.makeOpLeaC(FR2C_TY_L, (j>>4)&15,
				j&15, (k>>4)&15, (((k&15)<<8)|l));
		case FR2C_OP_LEA_FC:
			cs.ninc(); j=cs.getub_npp();
			k=cs.getub_npp(); l=cs.getub_npp();
			return FrOpLeaC.makeOpLeaC(FR2C_TY_F, (j>>4)&15,
				j&15, (k>>4)&15, (((k&15)<<8)|l));
		case FR2C_OP_LEA_DC:
			cs.ninc(); j=cs.getub_npp();
			k=cs.getub_npp(); l=cs.getub_npp();
			return FrOpLeaC.makeOpLeaC(FR2C_TY_D, (j>>4)&15,
				j&15, (k>>4)&15, (((k&15)<<8)|l));
		case FR2C_OP_LEA_BC:
			cs.ninc(); j=cs.getub_npp();
			k=cs.getub_npp(); l=cs.getub_npp();
			return FrOpLeaC.makeOpLeaC(FR2C_TY_SB, (j>>4)&15,
				j&15, (k>>4)&15, (((k&15)<<8)|l));
		case FR2C_OP_LEA_SC:
			cs.ninc(); j=cs.getub_npp();
			k=cs.getub_npp(); l=cs.getub_npp();
			return FrOpLeaC.makeOpLeaC(FR2C_TY_SS, (j>>4)&15,
				j&15, (k>>4)&15, (((k&15)<<8)|l));
		case FR2C_OP_LEA_PC:
			cs.ninc(); j=cs.getub_npp();
			k=cs.getub_npp(); l=cs.getub_npp();
			return FrOpLeaC.makeOpLeaC(FR2C_TY_P, (j>>4)&15,
				j&15, (k>>4)&15, (((k&15)<<8)|l));

		case FR2C_OP_INITARR:
			cs.ninc(); j=cs.getub_npp();
			k=cs.getus_npp();
			return FrOpInitArr.makeOpInitArr((j>>4)&15, j&15, k);
		...
		case FR2C_OP_CSRV:
			cs.ninc(); j=cs.getub_npp();
			return new OpCsrv((j>>4)&15, j&15);

		case FR2C_OP_NOP:
			cs.ninc();
			return new OpNop();
		case FR2C_OP_NOP2:
			cs.ninc(); j=cs.getub_npp()-2;
			if(j>0) { cs.nadd(j); }
			return new OpNop();
	...
	private static final class OpNop extends FrOpcode
		{ public void run(FrVMFrame frm) { } }

	private static final class OpCsrv extends FrOpcode
	{
		public OpCsrv(int w, int d)
			{ this.w=w; this.d=d; }
		public void run(FrVMFrame frm)
		{
			switch(w)
	...
	public static final int FR2C_OP_STOREINDEX_B		=0x54;
	public static final int FR2C_OP_STOREINDEX_S		=0x55;
	public static final int FR2C_OP_STOREINDEX_P		=0x56;
	public static final int FR2C_OP_LOADINDEX_UBC		=0x57;
	public static final int FR2C_OP_LOADINDEX_USC		=0x58;
...
//	public static final int FR2C_OP_STOREINDEX_P		=0x58;
	...
	public static final int FR2C_OP_INITARR			=0x77;
	public static final int FR2C_OP_CSRV_V			=0x78;
	public static final int FR2C_OP_CSRV				=0x79;
	public static final int FR2C_OP_CSRVW				=0x7A;

	public static final int FR2C_OP_LABEL				=0x7C;
	public static final int FR2C_OP_LABEL2			=0x7D;
	public static final int FR2C_OP_NOP2				=0x7E;
	public static final int FR2C_OP_NOP				=0x7F;
